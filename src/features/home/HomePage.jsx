...
export default function HomePage() {
  ...
  // ── SISTEMA DE SCROLL INFINITO CONTINUO (BUCLE SEAMLESS) ──────────────────
  useEffect(() => {
    const handleScroll = () => {
      // scrollHeight representa el máximo desplazamiento Y posible en el navegador
      const scrollHeight = document.documentElement.scrollHeight - window.innerHeight;
      const currentScroll = window.scrollY;

      // Cuando el usuario se encuentra sobre el Clon del Hero al final de la página (Y >= scrollHeight - 5)
      if (scrollHeight > 0 && currentScroll >= scrollHeight - 5) {
        // Hacemos una redirección invisible instantánea hacia el pixel 0 (Inicio Real)
        window.scrollTo(0, 0);
      }
    };
  ...
  return (
    <motion.div variants={pageVariants} initial="initial" animate="animate" exit="exit" className="relative">
      ...
      {/* ── PROXY DE SCROLL DE 6 PANELES DE NARRACIÓN (600vh) ────────────────── */}
      <div
        className="scroll-proxy pointer-events-none absolute left-0 right-0 top-0 w-full"
        style={{ height: '600vh', zIndex: -1 }}
      />

      {/* ─────────────────────────────────────────────────────────────────────
          BLOQUE 1: INICIO / LOGO (Hero Principal)
          ───────────────────────────────────────────────────────────────────── */}
      ...
      {/* ─────────────────────────────────────────────────────────────────────
          BLOQUE 2: SERAM SERVICE (Pilar 1 - Consultoría Territorial)
          ───────────────────────────────────────────────────────────────────── */}
      ...
      {/* ─────────────────────────────────────────────────────────────────────
          BLOQUE 3: SERAM ACADEMY (Pilar 2 - Educación Tecnológica Acreditada)
          ───────────────────────────────────────────────────────────────────── */}
      <section className="relative min-h-screen flex items-center justify-center py-24 px-4 sm:px-6 lg:px-8 bg-transparent">
        <div className="glass-panel-dark max-w-3xl mx-auto rounded-3xl p-8 sm:p-12 border border-white/[0.08] hover:border-[#00e03c]/20 transition-all flex flex-col items-center text-center space-y-6 shadow-[0_16px_40px_rgba(0,0,0,0.4)]">
          <div className="p-4 bg-slate-900/80 rounded-2xl text-[#00e03c] border border-white/10">
      ...
      {/* ─────────────────────────────────────────────────────────────────────
          BLOQUE 4: SERAM EXPERIENCE (Pilar 3 - Sostenibilidad Vivencial)
          ───────────────────────────────────────────────────────────────────── */}
      <section className="relative min-h-screen flex items-center justify-center py-24 px-4 sm:px-6 lg:px-8 bg-transparent">
        <div className="glass-panel-dark max-w-3xl mx-auto rounded-3xl p-8 sm:p-12 border border-white/[0.08] hover:border-[#00e03c]/20 transition-all flex flex-col items-center text-center space-y-6 shadow-[0_16px_40px_rgba(0,0,0,0.4)]">
          <div className="p-4 bg-slate-900/80 rounded-2xl text-[#00e03c] border border-white/10">
      ...
      {/* ─────────────────────────────────────────────────────────────────────
          BLOQUE 5: ECO-TIENDA SERAM (Consumo Consciente)
          ───────────────────────────────────────────────────────────────────── */}
      <section className="relative min-h-screen flex items-center justify-center py-24 px-4 sm:px-6 lg:px-8 bg-transparent">
      ...
      {/* ─────────────────────────────────────────────────────────────────────
          BLOQUE 6: ESPEJO DE INICIO/LOGO (Clon del Hero para Scroll Infinito)
          ───────────────────────────────────────────────────────────────────── */}
      <section className="relative overflow-hidden min-h-screen flex items-center justify-center py-24 px-4 sm:px-6 lg:px-8 bg-transparent select-none">
        <div className="absolute inset-0 opacity-10">
          <img
